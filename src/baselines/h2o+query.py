...
from EasyKV.easykv.citrus_average import enable_fixed_kv
import numpy as np
import gc
import json
from metrics import (
...
def main(model_name, quantization_type, device_map, segment_length, num_beams, kv_policy, cache_size, query_alpha):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--query_alpha', dest='query_alpha', action='store', required=False, default=1, type=float)
